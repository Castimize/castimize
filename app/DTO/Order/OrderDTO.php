...
class OrderDTO extends Data
{
    ...
    public static function fromWpRequest($request): self
    {
        ...
        return new self(
            customerId: (int) $wpOrder['customer_id'],
            customerStripeId: null,
            shopReceiptId: null,
            source: 'wp',
            wpId: (int) $wpOrder['id'],
            orderNumber: (int) $wpOrder['number'],
    ...
    public static function fromEtsyReceipt(Shop $shop, Receipt $receipt, array $lines): self
    {
        ...
        return new self(
            ...
            source: 'etsy',
            wpId: null,
            orderNumber: (int) $receipt->receipt_id,
            orderKey: (string) $receipt->receipt_id,
            ...
            email: $billingEmail ?? $customer->email ?? '',
