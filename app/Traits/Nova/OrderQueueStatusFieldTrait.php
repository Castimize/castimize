...
//                        Reprinted 🔙
        ...
        return Text::make(__('Status'), function () {
            return match ($this->status_slug) {
                ...
                default => '<span data-toggle="tooltip" data-placement="top" title="' . __('Completed') . '"><svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="rgb(34 197 94)" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7" /></svg></span>'
            };
        })
            ->hideOnExport()
            ->asHtml();
